...
describe("SWDvictories", () => {
  describe("rendering", () => {
    it("renders Military button", () => {
      render(<SWDvictories />);
      expect(
        screen.getByRole("button", { name: "Military" }),
      ).toBeInTheDocument();
    });
    ...
    it("does not render Political button by default", () => {
      render(<SWDvictories />);
      expect(
        screen.queryByRole("button", { name: "Political" }),
    ...
    it("renders Political button when showAgora is true", () => {
      ...
      expect(
        screen.getByRole("button", { name: "Political" }),
      ).toBeInTheDocument();
    });
  ...
  describe("click handlers", () => {
    ...
    it("calls onPoliticalVictory when Political button is clicked", () => {
      ...
      render(
        <SWDvictories showAgora={true} onPoliticalVictory={handlePolitical} />,
      );
